...
/*
export const lazyLoadingCop = path => {
  let filePath = path.replace(/.do$/, ".vue");
...
export const  getDays = (startDate, endDate) =>{
  ...
  if(startDate instanceof Date){
    ...
    sDate = new Date(...startDate.match(/\d+/g)).getTime()
  }

  if(endDate instanceof Date){
    eDate = endDate.getTime()
  }else{
    eDate = new Date(...endDate.match(/\d+/g)).getTime()
  }
  
  return  Math.floor((eDate - sDate)/(1*24*60*60*1000));
}
