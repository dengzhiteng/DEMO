define(function(require, exports, module) {
	//require('./css/ui.jqgrid.css');
	require('./css/ui.jqgrid-bootstrap.css');
	//require('./js/i18n/grid.locale-cn.js');
	require('./js/jqgrid.min.js');
	...
	window.computeTableHeight = function(patch){
		var $tableWrapper = $('.table_wrapper');
        if($tableWrapper.size() > 0 ){
        	var top = $tableWrapper.offset().top;
	        var winHH = $(window).height();
	        var compHH = winHH - top - patch;
	...
	$(window).resize(function () {
        ...
        $tableWrapper.find("table[id]").setGridWidth(width);
        var height = computeTableHeight(120);
        $tableWrapper.find("table[id]").setGridHeight(height); 
    });
});