		...
		return this.each(function() {
			...
			if( maxfrozen>=0 && frozen) {
				...
				if($t.p.footerrow) {
					...
					//$t.grid.fsDiv = $('<div style="position:absolute;left:0;top:'+(parseInt(top,10)+parseInt(hth,10) + parseInt(hbd,10) + 1 - pixelfix)+'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>');
					$t.grid.fsDiv = $('<div style="position:absolute;left:0;button:0;" class="frozen-sdiv ui-jqgrid-sdiv"></div>');
