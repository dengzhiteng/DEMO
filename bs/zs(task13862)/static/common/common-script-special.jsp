...
<script src="${webrootPath}/static/plugins/bootstrap-table/js/1.16.0/bootstrap-table.min.js?v=${version}"></script>
<script src="${webrootPath}/static/plugins/bootstrap-table/js/1.16.0/extention.js?v=${version}"></script>
<script src="${webrootPath}/static/plugins/bootstrap-table/ext/table-fixed-columns/index.js?v=${version}"></script>
